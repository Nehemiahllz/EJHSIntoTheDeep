...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2009.5530531588406; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2178.4779876794605; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2624.7904351649704; // x position of the perpendicular encoder (in tick units)
    }
