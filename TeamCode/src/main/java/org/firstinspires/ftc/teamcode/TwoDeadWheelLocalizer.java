...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1278.8006856240515; // y position of the parallel encoder (in tick units)
        public double perpXTicks =  -2914.282042554011; // x position of the perpendicular encoder (in tick units)
    }
    ...
    private int lastLeftBackPos, lastRightBackPos;
    ...
    public Twist2dDual<Time> update() {
        ...
        if (!initialized) {
            ...
            lastLeftBackPos = parPosVel.position;
            lastRightBackPos = perpPosVel.position;
            lastHeading = heading;
        ...
        int parPosDelta = parPosVel.position - lastLeftBackPos;
        int perpPosDelta = perpPosVel.position - lastRightBackPos;
